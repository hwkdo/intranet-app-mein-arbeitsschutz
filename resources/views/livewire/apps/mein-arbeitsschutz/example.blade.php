...
title('MeinArbeitsschutz - Beispiel');

state(['exampleData' => [
    'name' => 'Beispiel Item',
    'description' => 'Dies ist ein Beispiel-Item für die MeinArbeitsschutz App',
    'status' => 'active',
...
<x-intranet-app-mein-arbeitsschutz::mein-arbeitsschutz-layout heading="Beispiel-Seite" subheading="Demonstration der MeinArbeitsschutz-Funktionalität">
    <flux:card>
