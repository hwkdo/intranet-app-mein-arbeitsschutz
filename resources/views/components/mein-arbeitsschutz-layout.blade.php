...
@php
    $defaultNavItems = [
        ...
        ['label' => 'Chat', 'href' => route('apps.mein-arbeitsschutz.chat'), 'icon' => 'chat-bubble-left-right', 'description' => 'KI-Chat nutzen', 'buttonText' => 'Chat öffnen', 'requiresAiUsage' => true],        ['label' => 'App-Info', 'href' => route('apps.mein-arbeitsschutz.info'), 'icon' => 'information-circle', 'description' => 'Installierte Version und Release-Historie', 'buttonText' => 'App-Info anzeigen'],
